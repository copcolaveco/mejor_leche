...
class EstatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estate" do
    assert_difference('Estate.count') do
      post estates_url, params: { estate: { dicose: @estate.dicose, name: @estate.name, user_id: @estate.user_id } }
    end
  ...
  test "should update estate" do
    patch estate_url(@estate), params: { estate: { dicose: @estate.dicose, name: @estate.name, user_id: @estate.user_id } }
